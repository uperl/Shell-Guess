...
- [Win32::Process::Info](http://search.cpan.org/perldoc?Win32::Process::Info) and [Win32::Process::List](http://search.cpan.org/perldoc?Win32::Process::List)
...
[Shell::Config::Generate](http://search.cpan.org/perldoc?Shell::Config::Generate) provides a portable interface for generating
...
UNIXy platforms without a proc filesystem will use [Unix::Process](http://search.cpan.org/perldoc?Unix::Process) if installed, which will execute 
